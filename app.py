...
CASES = [
    ...
    {"id": 990, "crime_no": "REFNET202600990", "case_no": "REF-202600990", "title": "Linked network demonstration FIR", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Heinous", "station": "Central Police Station", "district": "Bengaluru Urban", "date": "25 Jul 2026", "time": "23:40", "location": "Majestic Transit Hub, Bengaluru", "lat": 12.9767, "lng": 77.5713, "officer": "Ananya Rao", "complainant": "Multiple reference complainants", "victim": "Multiple reference victims", "accused": ["Ravi Naik", "Mahesh K.", "Arjun Rao", "Faisal Khan", "Deepak S.", "Manoj Patil", "Rohit B.", "Sameer Ali", "Kiran Gowda", "Naveen R.", "Prakash M.", "Sanjay H."], "acts": ["BNS 309(4)", "BNS 3(5)"], "brief": "Synthetic high-density record used only to demonstrate graph navigation, linked identities and sequence playback.", "risk": 90},
    {"id": 991, "crime_no": "REFNET202600991", "case_no": "REF-202600991", "title": "Transit passenger robbery pattern", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Heinous", "station": "Upparpet Police Station", "district": "Bengaluru Urban", "date": "23 Jul 2026", "time": "22:55", "location": "Kempegowda Bus Station, Bengaluru", "lat": 12.9774, "lng": 77.5724, "officer": "S. Divya", "complainant": "Reference complainant 1", "victim": "Reference victim 1", "accused": ["Ravi Naik", "Arjun Rao", "Faisal Khan"], "acts": ["BNS 309(4)"], "brief": "Synthetic linked record for graph testing.", "risk": 86},
    {"id": 992, "crime_no": "REFNET202600992", "case_no": "REF-202600992", "title": "Late-night market robbery pattern", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Heinous", "station": "Cottonpet Police Station", "district": "Bengaluru Urban", "date": "20 Jul 2026", "time": "00:20", "location": "Cottonpet Main Road, Bengaluru", "lat": 12.9731, "lng": 77.5678, "officer": "Ananya Rao", "complainant": "Reference complainant 2", "victim": "Reference victim 2", "accused": ["Mahesh K.", "Deepak S.", "Manoj Patil"], "acts": ["BNS 309(4)", "BNS 3(5)"], "brief": "Synthetic linked record for graph testing.", "risk": 84},
    {"id": 993, "crime_no": "REFNET202600993", "case_no": "REF-202600993", "title": "Railway approach robbery pattern", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Heinous", "station": "City Railway Police Station", "district": "Bengaluru Urban", "date": "17 Jul 2026", "time": "23:10", "location": "Krantivira Sangolli Rayanna Station, Bengaluru", "lat": 12.9783, "lng": 77.5695, "officer": "R. Prakash", "complainant": "Reference complainant 3", "victim": "Reference victim 3", "accused": ["Rohit B.", "Sameer Ali", "Kiran Gowda"], "acts": ["BNS 309(4)"], "brief": "Synthetic linked record for graph testing.", "risk": 81},
    {"id": 994, "crime_no": "REFNET202600994", "case_no": "REF-202600994", "title": "Pedestrian robbery pattern", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Heinous", "station": "Chickpet Police Station", "district": "Bengaluru Urban", "date": "14 Jul 2026", "time": "22:30", "location": "Chickpet Metro, Bengaluru", "lat": 12.9669, "lng": 77.5748, "officer": "Ananya Rao", "complainant": "Reference complainant 4", "victim": "Reference victim 4", "accused": ["Naveen R.", "Prakash M.", "Sanjay H."], "acts": ["BNS 309(4)", "BNS 3(5)"], "brief": "Synthetic linked record for graph testing.", "risk": 79},
    {"id": 995, "crime_no": "REFNET202600995", "case_no": "REF-202600995", "title": "Mobile snatching network pattern", "category": "REFERENCE FIR", "major": "Crime Against Property", "minor": "Robbery", "status": "Under Investigation", "gravity": "Non-Heinous", "station": "Kalasipalya Police Station", "district": "Bengaluru Urban", "date": "11 Jul 2026", "time": "21:50", "location": "Kalasipalya Bus Stand, Bengaluru", "lat": 12.9606, "lng": 77.5763, "officer": "S. Divya", "complainant": "Reference complainant 5", "victim": "Reference victim 5", "accused": ["Ravi Naik", "Sameer Ali", "Naveen R."], "acts": ["BNS 304"], "brief": "Synthetic linked record for graph testing.", "risk": 76},
]
...
def init_db():
    with get_db() as db:
        ...
        if demo_seed_enabled() or env_flag("SEED_REFERENCE_CASES"):
            for case in CASES:
                db.execute("""INSERT OR IGNORE INTO cases(
                    id,crime_no,case_no,title,category,major_head,minor_head,status,gravity,station,district,
                    incident_date,incident_time,location,latitude,longitude,officer,complainant,victim,brief_facts,risk_score
                ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)""", (
...
def case_from_row(row, db=None):
    ...
    if str(data.get("brief", "")).startswith("PUBLIC-RECORD REFERENCE") or data.get("category") == "REFERENCE FIR":
        data["risk"] = -1
